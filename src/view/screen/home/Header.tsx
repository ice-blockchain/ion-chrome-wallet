...
import {AddIcon, ArrowDownIcon, CheckIcon, ImportIcon, UsbIconSmall, UserIcon,} from "../../components/Icons";
import {AccountStateContext, NetworkContext, NetworksContext,} from "../../context";
...
const Account: FC<{
    ...
    return (
        <AccountItem onClick={onClick}>
            ...
            {data && <Balance>{formatTonValue(data)} ICE</Balance>}
        </AccountItem>
    );
};
